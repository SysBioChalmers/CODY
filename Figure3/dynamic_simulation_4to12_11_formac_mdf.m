function [Tmodel,Y,Ymodel,Ymodel_met,met_udf_co]=dynamic_simulation_4to12_11_formac_mdf(community,n_spc,num_rct,FSG,Feed,flow_back,k,V,ini_stat,time,length_each_tank,km_lumen,Pn_mucosa,km_water,density,Met_Mass,hmo_para,vld,uv)
...
cm_met={};  
[cm_met,SxZ_tot]=calc_SxZ(met_udf_co,met_udf,SxZ,n_s);
...
[T Y]=my_runge_kutta4_smp_wait(@qssm_comm_8spc_reg_11_1_mac,y0,tspan,kmax,n_s,FSG,Feed,V,substrate_index,HMO_index,enzyme_index); 
ylg=lg_8tank;   
Tmodel=T;
[ys,yl]=size(Y);
Y(Y<0)=eps;
...
% plot_simulation_result_12m(Tmodel,Ymodel_met,met_udf_co,n_s);
