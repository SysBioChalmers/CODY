function [t,y]=my_runge_kutta4(ufunc,y0,tspan,k,ns,FS,FV,V_colon,substrate_index,HMO_index,enzyme_index)    %������˳��������΢�ַ�����ĺ������ƣ���ʼֵ������������ʱ����㣬ʱ���յ�,
t_ini=tspan(1);
t_final=tspan(2);
step=tspan(3);
...
for ii=1:N
   ...
   y(ii+1,:)=(y(ii,:)'+step*(k1+2*k2+2*k3+k4)/6)';       %���������������������ֵ���
   waitbar(ii / N)
end
close(h)
% close all
